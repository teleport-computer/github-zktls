...
# Manual verification using Basescan API
# Contract: 0x2bE419BCB663136b16cF2D163E309ECaf6B9887b
# Network: Base Sepolia (Chain ID: 84532)

CONTRACT_ADDRESS="0x2bE419BCB663136b16cF2D163E309ECaf6B9887b"
API_KEY="GQG6MI5VZJMYSHE7GHJJ32EUPJF3INUPCX"

# Create flattened source
echo "Creating flattened source..."
cat > /tmp/PredictionMarketV3Flat.sol << 'EOF'
...
echo "Flattened source created at /tmp/PredictionMarketV3Flat.sol"
echo ""
echo "To verify manually on Basescan:"
...
echo "4. Paste source from: /tmp/PredictionMarketV3Flat.sol"
echo "5. Constructor Arguments (ABI-encoded):"
echo "   0000000000000000000000000af922925ae3602b0dc23c4cfcf54fabe2f54725"
echo ""
